/**
 * @Title: Page4Navigator
 * @Auther: zhang
 * @Version: 1.0
 * @create: 2022/6/15 10:06
 */
...
public class Page4Navigator<T> {
    ...
    public Page4Navigator() {
        //这个空的分页是为了Redis 从 json格式转化为 Page4Navigator 对象而专门准备的
    }

    // 首先对 Page 类进行了封装，然后在构造方法里提供了一个 navigatePages 参数。 这个参数如果传7，那就是前面3个，后面3个。
    ...
    //计算数值，并返回到一个int 数组变量 navigatepageNums ，方便前端遍历展示。
